    ...
    try:
        ...
        if segments is None:
            ...
            if use_local_whisper:
                segments = transcriber.transcribe_locally(temp_audio_path, initial_prompt)
            else:
                print("Using OpenAI Whisper API...")
                print(temp_audio_path)
                segments = transcriber.transcribe_with_api(temp_audio_path, initial_prompt)
        ...
        for caption in captions:
            ...
            for current_index, caption in enumerate(captions_to_draw):
                ...
                for line in line_data["lines"]:
                    pos = position or ("center", text_y_offset)
